    ...
    metaDataConfig)
{
    ...
    for(let totalData of listTotalData){
        ...
        if(totalData.january){
            validPeriodReported=new Date(`${totalData.year-dicMonthDigit[totalData.january]}-01`
            ).toISOString().split("T")[0];
            console.log(`string data=${totalData.year-dicMonthDigit[totalData.january]}-01, convertedDate=${validPeriodReported}`);
        ...
        if(totalData.february){
            groupObject=null;
            validPeriodReported=new Date(`${totalData.year-dicMonthDigit[totalData.february]}-01`
        ).toISOString().split("T")[0];
        groupObject= {group:[{_attr:{orgUnit:oResolvedOrUnit.id,period:validPeriodReported+"/P1M",
        ...
        if(totalData.march){
            groupObject=null;
            validPeriodReported=new Date(`${totalData.year-dicMonthDigit[totalData.march]}-01`
            ).toISOString().split("T")[0];
            groupObject= {group:[{_attr:{orgUnit:oResolvedOrUnit.id,period:validPeriodReported+"/P1M",
        ...
        if(totalData.april){
            groupObject=null;
            validPeriodReported=new Date(`${totalData.year-dicMonthDigit[totalData.april]}-01`
            ).toISOString().split("T")[0];
            groupObject= {group:[{_attr:{orgUnit:oResolvedOrUnit.id,period:validPeriodReported+"/P1M",
        ...
        if(totalData.may){
            groupObject=null;
            validPeriodReported=new Date(`${totalData.year-dicMonthDigit[totalData.may]}-01`
            ).toISOString().split("T")[0];
            groupObject= {group:[{_attr:{orgUnit:oResolvedOrUnit.id,period:validPeriodReported+"/P1M",
            completeDate:validPeriodReported}},{dataValue:[{_attr:{dataElement:idDataElement,
            value:totalData.may}}]}
        ...
        if(totalData.june){
            groupObject=null;
            validPeriodReported=new Date(`${totalData.year-dicMonthDigit[totalData.june]}-01`
            ).toISOString().split("T")[0];
            groupObject= {group:[{_attr:{orgUnit:oResolvedOrUnit.id,period:validPeriodReported+"/P1M",
            completeDate:validPeriodReported}},{dataValue:[{_attr:{dataElement:idDataElement,
        ...
        if(totalData.july){
            groupObject=null;
            validPeriodReported=new Date(`${totalData.year-dicMonthDigit[totalData.july]}-01`
            ).toISOString().split("T")[0];
            groupObject= {group:[{_attr:{orgUnit:oResolvedOrUnit.id,period:validPeriodReported+"/P1M",
            completeDate:validPeriodReported}},{dataValue:[{_attr:{dataElement:idDataElement,
        ...
        if(totalData.august){
            groupObject=null;
            validPeriodReported=new Date(`${totalData.year-dicMonthDigit[totalData.august]}-01`
            ).toISOString().split("T")[0];
            groupObject= {group:[{_attr:{orgUnit:oResolvedOrUnit.id,period:validPeriodReported+"/P1M",
            completeDate:validPeriodReported}},{dataValue:[{_attr:{dataElement:idDataElement,
        ...
        if(totalData.september){
            groupObject=null;
            validPeriodReported=new Date(`${totalData.year-dicMonthDigit[totalData.september]}-01`
            ).toISOString().split("T")[0];
            groupObject= {group:[{_attr:{orgUnit:oResolvedOrUnit.id,period:validPeriodReported+"/P1M",
            completeDate:validPeriodReported}},{dataValue:[{_attr:{dataElement:idDataElement,
        ...
        if(totalData.october){
            groupObject=null;
            validPeriodReported=new Date(`${totalData.year-dicMonthDigit[totalData.october]}-01`
            ).toISOString().split("T")[0];
            groupObject= {group:[{_attr:{orgUnit:oResolvedOrUnit.id,period:validPeriodReported+"/P1M",
            completeDate:validPeriodReported}},{dataValue:[{_attr:{dataElement:idDataElement,
        ...
        if(totalData.november){
            groupObject=null;
            validPeriodReported=new Date(`${totalData.year-dicMonthDigit[totalData.november]}-01`
            ).toISOString().split("T")[0];
            groupObject= {group:[{_attr:{orgUnit:oResolvedOrUnit.id,period:validPeriodReported+"/P1M",
            completeDate:validPeriodReported}},{dataValue:[{_attr:{dataElement:idDataElement,
        ...
        if(totalData.december){
            groupObject=null;
            validPeriodReported=new Date(`${totalData.year-dicMonthDigit[totalData.december]}-01`
            ).toISOString().split("T")[0];
            groupObject= {group:[{_attr:{orgUnit:oResolvedOrUnit.id,period:validPeriodReported+"/P1M",
            completeDate:validPeriodReported}},{dataValue:[{_attr:{dataElement:idDataElement,
